...
public class EntityUtil {
    ...
    private final String moduleName = "timeshop"; // 数据库名称

    private final String bean_path = "D:\\笔墨屋实训\\代码\\seckill-parent\\seckill-service\\src\\main\\java";

    private final String mapper_path = "D:\\笔墨屋实训\\代码\\seckill-parent\\seckill-service\\src\\main\\java\\com\\xiaoliu\\seckill\\dao";

    private final String xml_path = "D:\\笔墨屋实训\\代码\\seckill-parent\\seckill-service\\src\\main\\resources\\Mapping";// xml路径

    private final String model_package = "com.xiaoliu.seckill.model";// model的包所在

    private final String dao_package = "com.xiaoliu.seckill.dao";// dao的包所在
