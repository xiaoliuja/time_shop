...
<div id="maincontent">
    ...
    <div class="rightinfo">
        <div class="formbody">
            <form name="submitForm" id="submitForm" action="${ctx}/product/listPage"  method="post">
                <table width="90%">
                    <tbody>
                    ...
                    <tr>
                        <td width="50%"><label>商品name:</label><input type="text" class="dfinput" name="name" id="name" value="${name}"/></td>
                ...
                <table width="90%"  class="tablelist">
                    ...
                    <c:forEach items="${list}" var="record" varStatus="status">
                        <tr>
                            ...
                            <td><fmt:formatDate value="${record.updatedTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                            <td><fmt:formatDate value="${record.startBuyTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                            ...
                            <td>
                                <c:choose>
                                    ...
                                    <c:when test="${0 == record.isDeleted}">正常</c:when>
